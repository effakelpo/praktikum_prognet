            ...
            <div class="col-lg-8 offset-lg-1">
                ...
                <div class="product-slider owl-carousel">
                    <div class="product-item">
                        <div class="pi-pic">
                            <img src="{{ asset('/assets-user/img/products/women-1.jpg') }}" alt="">
                    ...
                    <div class="product-item">
                        <div class="pi-pic">
                            <img src="{{ asset('/assets-user/img/products/women-2.jpg') }}" alt="">
                            <div class="icon">
                                <i class="icon_heart_alt"></i>
                            </div>
                            <ul>
                    ...
                    <div class="product-item">
                        <div class="pi-pic">
                            <img src="{{ asset('/assets-user/img/products/women-3.jpg') }}" alt="">
                            <div class="icon">
                                <i class="icon_heart_alt"></i>
                            </div>
                            <ul>
                    ...
                    <div class="product-item">
                        <div class="pi-pic">
                            <img src="{{ asset('/assets-user/img/products/women-4.jpg') }}" alt="">
                            <div class="icon">
                                <i class="icon_heart_alt"></i>
                            </div>
                            <ul>
        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="product-slider owl-carousel">
                    <div class="product-item">
                        <div class="pi-pic">
                            <img src="{{ asset('/assets-user/img/products/man-1.jpg') }}" alt="">
                            <div class="sale">Sale</div>
                            <div class="icon">
                                <i class="icon_heart_alt"></i>
                            </div>
                    ...
                    <div class="product-item">
                        <div class="pi-pic">
                            <img src="{{ asset('/assets-user/img/products/man-2.jpg') }}" alt="">
                            <div class="icon">
                                <i class="icon_heart_alt"></i>
                            </div>
                            <ul>
                    ...
                    <div class="product-item">
                        <div class="pi-pic">
                            <img src="{{ asset('/assets-user/img/products/man-3.jpg') }}" alt="">
                            <div class="icon">
                                <i class="icon_heart_alt"></i>
                            </div>
                            <ul>
                    ...
                    <div class="product-item">
                        <div class="pi-pic">
                            <img src="{{ asset('/assets-user/img/products/man-4.jpg') }}" alt="">
                            <div class="icon">
                                <i class="icon_heart_alt"></i>
                            </div>
                            <ul>
